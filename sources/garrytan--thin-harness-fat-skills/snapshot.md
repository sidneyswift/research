...
Source: Garry Tan (@garrytan), essay "Thin Harness, Fat Skills" (AI Explainer series, essay #1 of 8)
Captured: 2026-06-01 (pasted by Sidney Swift; canonical URL + publication date not yet confirmed — TODO)
Internal date evidence: references the Claude Code npm source leak of "March 31, 2026" and a "July 2026" Startup School event being planned — so written ~April 2026.
Citation page: sources/garrytan--thin-harness-fat-skills.md
