...
Source: Garry Tan (@garrytan), essay "Resolvers: The Routing Table for Intelligence" (AI Explainer series, essay #2 of 8)
Captured: 2026-06-01 (pasted by Sidney Swift; canonical URL + publication date not yet confirmed — TODO)
Internal date evidence: builds directly on "Thin Harness, Fat Skills"; references Will Manidis's "No New Deal for OpenAI" and Claude Code's AutoDream. Written ~April–May 2026.
Citation page: sources/garrytan--resolvers.md
