---
title: "P.A.R.A — An Introduction"
author: "Tiago Forte"
date: 2020-08-08
url: https://every.to/forte-labs/para-an-introduction-827085
words: 3374
---
...
Imagine for a moment the perfect project management system. One that supported and enhanced the work you do, telling you exactly where to put a piece of information, and exactly where to find it when you needed it.
...
How does goal planning come into play with P.A.R.A.? Do you do that planning in a separate place outside the P.A.R.A. system and then feed it in? I imagine the goals would reveal the Areas I would want to focus in on. Would I then place those goals inside a "goals" note within the Area they are relevant to? Because goals are not "how," I wonder, if Areas are Archived, the goal itself may still be unachieved and get moved to a new Area that is relevant to that unachieved (yet still desired) goal.

@paul_7380 I should mention, I appreciate the mention of projects/goals, hobbies/dreams. Just wondering where I'd have my goal list live.
